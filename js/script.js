...
let aviso = document.querySelector (".telaD2");
let lateral = document.querySelector (".telaD1Right");
  ...
  if (candidato.length > 0) {
    ...
    for(let i in candidato.fotos) {
      if (candidato.fotos[i].small) {
        fotosHtml += `<div class="telaD1RightImage"><img class="image2 small" src="./images/${candidato.fotos[i].url}"
        alt="Candidato Prefeito"/>${candidato.fotos[i].legenda}</div>`;
      
      } else {
      fotosHtml += `<div class="telaD1RightImage"><img class="image1" src="./images/${candidato.fotos[i].url}"
        alt="Candidato Prefeito"/>${candidato.fotos[i].legenda}</div>`;
      }
    }
